...
16. [lambda](http://blog.csdn.net/booirror/article/details/26973611)匿名函数
17. C++11中的std::[function](http://www.jellythink.com/archives/771),对各种可调用实体（普通函数、Lambda表达式、函数指针、以及其它函数对象等）的封装，形成一个新的可调用的std::function对象
